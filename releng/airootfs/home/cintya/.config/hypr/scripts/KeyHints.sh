...
" Shift W " "kills an active window" "(kill)" \
" ALT mouse scroll up/down   " "Desktop Zoom" "Desktop Magnifier" \
" Alt V" "Clipboard Manager" "(cliphist)" \
" Q" "Choose wallpaper" "(Wallpaper Menu)" \
" Shift Q" "Choose wallpaper effects" "(imagemagick + swww)" \
"CTRL ALT Q" "Random wallpaper" "(via swww)" \
